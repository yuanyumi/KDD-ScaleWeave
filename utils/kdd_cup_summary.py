# KDDCup summary utility — SMAPE-only.
...
class KDDCupSummary:
    def __init__(self, file_path, root_path):
        ...
        self.test_set = KDDCupDataset.load(training=False, dataset_file=root_path)

    def evaluate(self):
        grouped_smapes, grouped_mapes = {}, {}
        for group_name in KDDCupMeta.seasonal_patterns:
    ...
    def summarize_groups(self, scores):
        ...
        weighted = {}
        total_count = 0
        for g in KDDCupMeta.seasonal_patterns:
            if g not in scores:
                continue
            c = group_count(g)
