# NN5 summary utility — SMAPE-only.
...
class NN5Summary:
    def __init__(self, file_path, root_path):
        ...
        self.test_set = NN5Dataset.load(training=False, dataset_file=root_path)

    def evaluate(self):
        grouped_smapes, grouped_mapes = {}, {}
        for group_name in NN5Meta.seasonal_patterns:
    ...
    def summarize_groups(self, scores):
        ...
        weighted = {}
        total_count = 0
        for g in NN5Meta.seasonal_patterns:
            if g not in scores:
                continue
            c = group_count(g)
