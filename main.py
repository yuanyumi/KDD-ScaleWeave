...
parser.add_argument('--wd_project', default='scaleweave', type=str)
...
parser.add_argument('--sch_layers', type=int, default=2, help='number of ScaleWeave message-passing layers')
