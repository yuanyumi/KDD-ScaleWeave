...
class Dataset_Hospital(Dataset):
    """Hospital dataset for short-term forecasting.
    ...
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='hospital', target='OT',
        ...
        self.history_size = HospitalMeta.history_size[seasonal_patterns]
    ...
    def __read_data__(self):
        if self.flag == 'train':
            dataset = HospitalDataset.load(training=True, dataset_file=self.root_path)
        else:
            dataset = HospitalDataset.load(training=False, dataset_file=self.root_path)
