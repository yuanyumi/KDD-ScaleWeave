...
from data_provider.nn5 import NN5Dataset, NN5Meta


class Dataset_NN5(Dataset):
    """NN5 dataset for short-term forecasting.
    ...
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='nn5', target='OT',
        ...
        self.history_size = NN5Meta.history_size[seasonal_patterns]
    ...
    def __read_data__(self):
        if self.flag == 'train':
            dataset = NN5Dataset.load(training=True, dataset_file=self.root_path)
        else:
            dataset = NN5Dataset.load(training=False, dataset_file=self.root_path)
