...
from data_provider.m1 import M1Dataset, M1Meta


class Dataset_M1(Dataset):
    """M1 dataset for short-term forecasting.
    ...
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='m1', target='OT',
        ...
        self.history_size = M1Meta.history_size[seasonal_patterns]
    ...
    def __read_data__(self):
        if self.flag == 'train':
            dataset = M1Dataset.load(training=True, dataset_file=self.root_path)
        else:
            dataset = M1Dataset.load(training=False, dataset_file=self.root_path)
