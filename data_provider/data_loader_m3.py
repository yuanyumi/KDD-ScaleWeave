...
class Dataset_M3(Dataset):
    """M3 dataset for short-term forecasting.
    ...
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='m3', target='OT',
    ...
    def __read_data__(self):
        if self.flag == 'train':
            dataset = M3Dataset.load(training=True, dataset_file=self.root_path)
        else:
            dataset = M3Dataset.load(training=False, dataset_file=self.root_path)
