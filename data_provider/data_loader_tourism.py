...
class Dataset_Tourism(Dataset):
    """Tourism dataset for short-term forecasting.
    ...
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='tourism', target='OT',
        ...
        self.history_size = TourismMeta.history_size[seasonal_patterns]
    ...
    def __read_data__(self):
        if self.flag == 'train':
            dataset = TourismDataset.load(training=True, dataset_file=self.root_path)
        else:
            dataset = TourismDataset.load(training=False, dataset_file=self.root_path)
